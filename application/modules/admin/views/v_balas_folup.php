                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="POST" >
                                        <div class="form-group">
                                            ...
                                            <textarea name="tiket_balas_prod" style="height: 300px" class="form-control" placeholder="Enter text" required="" ><?=$tiket['tiket_balas_prod']?></textarea>
                                        </div>
                                        <?php if ($tiket['tiket_balas_prod'] <> '') {
