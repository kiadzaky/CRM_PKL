                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id = "baris_<?=$id++?>" onclick="showModal('<?=$ids++?>')" data-tiket_id = "<?=$t->tiket_id?>" data-produk = "<?=$tiket_produk?>" data-menu = "<?= $t->menu?>" data-pesan = "<?=$t->tiket_pesan?>" data-toggle="modal" data-target="#myModal"> 
                                            <td><?=$no++?></td>
                                            <td><?=$tiket_produk?></td>
                                            <td><?=$t->menu?></td>
        ...
        <script type="text/javascript">
            function showModal(tiket_id) {
                $('#myModal').on('shown.bs.modal', function () {
                  ...
                  $('#link').attr("href", "<?=base_url('admin/balas_folup/')?>"+id);
                })
            }
        </script>